...
/*Agregar evento para el dibujo continuo al moder el raton*/
...
function alisarTrazados(ry){
    ...
    for(let i = 1; i < ry.length - 2; i++){   
        let pc = calcularPuntosDeControl(ry, i, i + 1); //Calcular el punto de control
...
function redibujarTrazados(){
    ...
    Trazados.forEach(Trazado => alisarTrazados(Trazado)); //Suavizar y redibujar los trazos
}
